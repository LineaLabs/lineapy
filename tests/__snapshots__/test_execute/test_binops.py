...
lineapy_tracer.assign(variable_name='b', value_node=lineapy_tracer.call(
    function_name='add', syntax_dictionary={'lineno': 1, 'col_offset': 4,
    'end_lineno': 1, 'end_col_offset': 9}, arguments=[1, 2],
...
assert lineapy_tracer.call(function_name='eq', syntax_dictionary={'lineno':
    2, 'col_offset': 7, 'end_lineno': 2, 'end_col_offset': 13}, arguments=[
