...
lineapy_tracer.assign(variable_name='b', value_node=lineapy_tracer.call(
    function_name='lt', syntax_dictionary={'lineno': 1, 'col_offset': 4,
    'end_lineno': 1, 'end_col_offset': 13}, arguments=[lineapy_tracer.call(
    function_name='lt', syntax_dictionary={'lineno': 1, 'col_offset': 4,
    'end_lineno': 1, 'end_col_offset': 13}, arguments=[1, 2],
