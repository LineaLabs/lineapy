...
call_3 = CallNode(
    ...
    positional_args=[call_2.id, literal_7.id, literal_5.id],
)
call_4 = CallNode(
    source_location=SourceLocation(
        lineno=3,
    ...
    positional_args=[call_3.id, literal_1.id],
)
call_5 = CallNode(
    source_location=SourceLocation(
        lineno=3,
...
call_7 = CallNode(
    ...
    positional_args=[call_5.id, literal_12.id],
)
call_8 = CallNode(
    source_location=SourceLocation(
        lineno=5,
...
call_9 = CallNode(
    ...
    positional_args=[call_4.id, literal_13.id],
)
call_10 = CallNode(
    source_location=SourceLocation(
        lineno=6,
...
call_11 = CallNode(
    ...
    positional_args=[call_2.id, literal_14.id],
)
