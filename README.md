...
[![Documentation Status](https://readthedocs.com/projects/lineapy-org-lineapy/badge/?version=latest&token=925cd1d5eaedb7cc60508c9cce377574da748a7d6c050bb2c3de2a360a9f4f20)](https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/index.html)
...
[here](https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/guides/contribute/setup.html#installation).

LineaPy offers several extras to extend its core capabilities, such as support for PostgreSQL or Amazon S3.
Learn more about these and other installation options [here](https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/guides/installation.html#extras).
...
Let's say you're happy with your above code, and you've decided to save the trained model. You can store the model as a LineaPy [artifact](https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/concepts/artifact.html) with the following code:
...
[tutorial](https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/tutorials/02_pipeline_building.html) for more details.)
...
To learn more about LineaPy, please check out the project [documentation](https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/index.html)
...
[Docs]: https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/index.html
[Concepts]: https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/concepts/artifact.html
...
[API Reference]: https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/references/api_reference.html
[Contribute]: https://docs.lineapy.org/en/lin-716-reorg-rtd-contents/guides/contribute/index.html
