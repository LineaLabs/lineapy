...
class MetadataExtractor(GraphReader):
    ...
    ) -> List[DataSourceNode]:  # type: ignore
    ...
    def score_graph_similarity(self, program_one: Graph, program_two: Graph):
        ...
        We should probably have another function that projects the graph
        down into some values that we can do similarity score on more easily.
        """
